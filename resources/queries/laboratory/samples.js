...
//    }
    ...
    if(row.TumorNormal == "Normal" && ((row.TumorType == "Primary") || (row.TumorType == "Metastatic"))) {
        errors[field] = 'Tumor Type value must be Not applicable';
    }   //  fi

    if(row.TumorNormal == "Tumor" && row.TumorType == "Not applicable") {
        errors[field] = 'Tumor Type value must be Primary, Metastatic, or Unknown';
    }   //  fi
