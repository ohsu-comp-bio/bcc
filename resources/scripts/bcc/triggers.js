...
exports.init = function(event, errors){
    ...
    if (this.onInit){
        this.onInit.call(this, event, errors, BCC);
    }
}
...
exports.beforeInsert = function(row, errors){
    ...
    if (handlers.length){
        for (var i=0;i<handlers.length;i++){
            handlers[i].call(this, row, errors, BCC);
        }
    }
}
...
exports.afterInsert = function(row, errors){
    if (this.onAfterInsert){
        this.onAfterInsert.call(this, row, errors, BCC);
    }
}
...
exports.beforeUpdate = function(row, oldRow, errors){
    ...
    if (handlers.length){
        for (var i=0;i<handlers.length;i++){
            handlers[i].call(this, row, oldRow, errors, BCC);
        }
    }
}
...
exports.beforeDelete = function(row, errors){
    if (this.onDelete)
        this.onDelete.call(this, row, errors, BCC);
...
exports.complete = function(event, errors) {
    if (this.onComplete)
        this.onComplete.call(this, event, errors, BCC);

}

exports.initScript = function(scope){
    var props = ['BCC', 'LABKEY', 'Ext', 'console', 'init', 'beforeInsert', 'afterInsert', 'beforeUpdate', 'afterUpdate', 'beforeDelete', 'afterDelete', 'complete'];
